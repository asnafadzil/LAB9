...
$_SESSION["myLogin"] = "myWebsite"; echo "A value saved in the session named as myLogin.<br>";
echo " A value saved in the session named as myLogin.<br>";

$_SESSION["myColor"] = "Blue"; echo "A value saved in the session named as myColor.<br>";
